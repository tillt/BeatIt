...
int main() {
    ...
    cfg.name = "Enigma";
    cfg.audio_filename = "enigma.wav";
    cfg.dump_env_var = "BEATIT_ENIGMA_DUMP_EVENTS";
    ...
    cfg.expected_first_downbeat_sample_frame = 986ULL;
    cfg.first_downbeat_sample_tolerance_ms = 10.0;

    cfg.target_bpm = 126.0;
    cfg.max_bpm_error = 0.01;

    cfg.max_intro_median_abs_ms = 6.5;
    cfg.max_offset_slope_ms_per_beat = 0.003;
    cfg.max_start_end_delta_ms = 3.8;
    cfg.max_start_end_delta_beats = 0.008;
    cfg.max_odd_even_median_gap_ms = 8.5;
