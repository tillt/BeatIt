//
//  rhodes_window_alignment_test.mm
//  BeatIt
//
...
int main() {
    ...
    cfg.name = "Rhodes";
    cfg.audio_filename = "rhodes.wav";
    cfg.dump_env_var = "BEATIT_RHODES_DUMP_EVENTS";

    cfg.event_probe_count = 16;

    cfg.expected_first_downbeat_sample_frame = 3525ULL;
