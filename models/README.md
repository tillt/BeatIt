...
You can train and export a model using the scripts in `scripts/`.
...
python scripts/beatthis_export_torchscript.py \
  --checkpoint models/beat_this-small0.ckpt \
...
- `models/beatthis.pt` is exported from `models/beat_this-small0.ckpt`.
